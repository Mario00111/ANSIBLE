...
#
#-------------------------------------------------------------------------------
#	Shell Transfert_KSLtoPM.sh appele KSL serveur 
#
#
#	 Droit d'auteur : St+©phane Le LAbourier (qui a pomp+© sur le shell de Fabrice Devin)
#                   Correction erreur suppression fichier de log si debug = "n" (FD)
...
echo "${Horodateur} : ************Lancement du shell avec les paramètres suivants ${1} ${2} ${3} ${4} ${5} ${6}" >> ${FicLog}
