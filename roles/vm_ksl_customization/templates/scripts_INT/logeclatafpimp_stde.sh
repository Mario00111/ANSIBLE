...
#
#-------------------------------------------------------------------------------
#	Shell logeclatafpimp_stde.sh appelé par PostTraitKSL_STDE_Prod.sh
#
#
#	yann kloniecki
...
# pour le cas des fichiers éclatés, le nom *.IMP_03
# doit être différent pour chaque fichier transmis
# au scrutateur
...
echo $impeditsanspoint >> $LOG		# impedit avec _ à la place des .
echo $ged >> $LOG			# ged
